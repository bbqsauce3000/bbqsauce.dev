...
// include: /tmp/tmp5yff9ntb.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'fish.data';
      var REMOTE_PACKAGE_BASE = 'fish.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_fish.data');
      }
      Module['addRunDependency']('datafile_fish.data');
    ...
    loadPackage({"files": [{"filename": "/fish.obj", "start": 0, "end": 41253}], "remote_package_size": 41253});

  })();

// end include: /tmp/tmp5yff9ntb.js
// include: /tmp/tmpih6u79m7.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpih6u79m7.js
// include: /tmp/tmp31057c3w.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp31057c3w.js
...
var ASM_CONSTS = {
 ...
 100024: () => { return Module.canvas.width; },  
 100056: () => { return parseInt(Module.canvas.style.width); },  
 100104: () => { document.exitFullscreen(); },  
 100131: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 100203: () => { if (document.fullscreenElement) return 1; },  
 100249: () => { return Module.canvas.width; },  
 100281: () => { return screen.width; },  
 100306: () => { document.exitFullscreen(); },  
 100333: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 100527: () => { return window.innerWidth; },  
 100553: () => { return window.innerHeight; },  
 100580: () => { if (document.fullscreenElement) return 1; },  
 100626: () => { return Module.canvas.width; },  
 100658: () => { return parseInt(Module.canvas.style.width); },  
 100706: () => { if (document.fullscreenElement) return 1; },  
 100752: () => { return Module.canvas.width; },  
 100784: () => { return screen.width; },  
 100809: () => { return window.innerWidth; },  
 100835: () => { return window.innerHeight; },  
 100862: () => { if (document.fullscreenElement) return 1; },  
 100908: () => { return Module.canvas.width; },  
 100940: () => { return screen.width; },  
 100965: () => { document.exitFullscreen(); },  
 100992: () => { if (document.fullscreenElement) return 1; },  
 101038: () => { return Module.canvas.width; },  
 101070: () => { return parseInt(Module.canvas.style.width); },  
 101118: () => { document.exitFullscreen(); },  
 101145: ($0) => { Module.canvas.style.opacity = $0; },  
 101183: () => { return screen.width; },  
 101208: () => { return screen.height; },  
 101234: () => { return window.screenX; },  
 101261: () => { return window.screenY; },  
 101288: () => { return window.devicePixelRatio; },  
 101324: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101377: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 101428: () => { Module.canvas.style.cursor = 'none'; },  
 101465: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101721: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 101772: () => { if (document.pointerLockElement) return 1; },  
 101819: () => { if (document.fullscreenElement) return 1; },  
 101865: () => { return window.innerWidth; },  
 101891: () => { return window.innerHeight; }
};
